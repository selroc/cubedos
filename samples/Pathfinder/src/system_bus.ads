...
--
-- System_Bus is intended to be the main interface for the Pathfinder sample
-- program.
--------------------------------------------------------------------------------
...
package System_Bus is
   ...
   FSeed   : constant Fibonacci.Fib_Seed               := 30;
   Pri     : constant System.Priority                  := 40;
   CPU_Num : constant System.Multiprocessors.CPU_Range :=
