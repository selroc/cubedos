...
private
   ...
   procedure Handle_Telemetry_Request (Message : in Message_Record) with
      Pre => System_Bus.API.Is_Telemetry_Request (Message);
   procedure Handle_Telemetry_Reply (Message : in Message_Record) with
      Pre => System_Bus.API.Is_Telemetry_Reply (Message);
